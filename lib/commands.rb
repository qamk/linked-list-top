...
module Commands
  def welcome
    puts %(
      ...
      This allows you to dynamically change the size of a list (many languages have static arrays which have fixed sizes).
...
def call_method(method)
  ...
  if %w[size pop to_s commands].include? method
    ...
    print 'Please enter the index you want to look at (0 gets the first item): '
